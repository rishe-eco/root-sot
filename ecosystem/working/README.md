...
- **`root-website-research-lab.md`** — spec (not built): the **Research Lab**, a public bilingual library of referenced + own research under the **Content** section (opens the Root Cast content lock; one strand of Content, beside Root Cast). Concept tree + list + search, translation provenance, public/private visibility, admin + contributor curation, agent last. *(2026-08-01.)*
