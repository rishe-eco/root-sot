...
**From:** _root
**Status:** Build plan — sequences three specs. **Twelve of fourteen built; R3 (conditional) or the Persian pass next.**
**Version:** 0.12 · 2026-08-13 · Owner: _root
...
**Struck through as of 2026-08-13.** Twelve of fourteen are built. **Three have moved out of their planned slots** — C0 forward (§5b), C1 ahead of R3 (taking the escape hatch the previous revision of this paragraph offered), and now **R4 ahead of R3 as well**, on founder direction, for the same reason and with the same standing condition.
...
**Which leaves the Persian pass as the default next**, and it is the one stage whose file is a *proposal* rather than a plan — nothing ever specified what the pass is, so [`persian-pass.md`](../../../root-app/docs/development/persian-pass.md) says what it thinks it should be and asks to be argued with before anyone starts. It also now carries the first defect found *for* it rather than *by* it (§1.6.1).
